...
namespace SnailChess.AI.Personalities
{
    ...
    {
        public static readonly BotPersonality EASY = new BotPersonality()
        {
            /* ---------------------------- 
                Search
            ------------------------------- */
            ...
            evaluationParams = new EvaluationParams(
                ...
                _protected_passed_pawn_bonus: 0,
                _protected_passed_pawn_bonus_eg: 5,
                ...
                _bishop_pair_score_eg:  5,
                _rook_pair_score:       3,
                _rook_pair_score_eg:    5,
                _knight_pair_score:     5,
                _knight_pair_score_eg: -5
            )
        };
    }
}